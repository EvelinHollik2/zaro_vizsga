...
<footer class="container-fluid bg-dark text-white">
    <div class="container d-flex justify-content-between row mx-auto py-5">
        ...
        <div class="col-4">
            <h4>Follow Us</h4>
            <p><a href="https://www.facebook.com/?locale=hu_HU" target="_blank"><img src="./Kepek/Facebook Iconvector.svg" alt="Facbook" class="plat"></a><a href="https://www.instagram.com/" target="_blank"><img src="./Kepek/Instagram Iconvector.svg" alt="Instagram" class="plat"></a><a href="https://twitter.com/?lang=hu" target="_blank"><img src="./Kepek/Twitter Iconvector.svg" alt="Twitter" class="plat"></a></p>
        </div>
    </div>
</footer>
